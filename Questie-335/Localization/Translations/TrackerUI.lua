...
local trackerUILocales = {
    ...
    ["Bot Quests"] = {
        ["ptBR"] = "Missões dos Bots",
        ["ruRU"] = "Задания ботов",
        ["deDE"] = "Bot-Quests",
        ["koKR"] = "봇 퀘스트",
        ["esMX"] = "Misiones de bots",
        ["enUS"] = true,
        ["zhCN"] = "机器人任务",
        ["zhTW"] = "機器人任務",
        ["esES"] = "Misiones de bots",
        ["frFR"] = "Quêtes des bots",
    },
    ["Cached Bot Quests"] = {
        ["ptBR"] = "Missões dos Bots em Cache",
        ["ruRU"] = "Кэшированные задания ботов",
        ["deDE"] = "Zwischengespeicherte Bot-Quests",
        ["koKR"] = "캐시된 봇 퀘스트",
        ["esMX"] = "Misiones de bots en caché",
        ["enUS"] = true,
        ["zhCN"] = "缓存的机器人任务",
        ["zhTW"] = "快取的機器人任務",
        ["esES"] = "Misiones de bots en caché",
        ["frFR"] = "Quêtes des bots en cache",
    },
    ["Archived Bot Quests"] = {
        ["ptBR"] = "Missões dos Bots Arquivadas",
        ["ruRU"] = "Архивные задания ботов",
        ["deDE"] = "Archivierte Bot-Quests",
        ["koKR"] = "보관된 봇 퀘스트",
        ["esMX"] = "Misiones de bots archivadas",
        ["enUS"] = true,
        ["zhCN"] = "已归档的机器人任务",
        ["zhTW"] = "已封存的機器人任務",
        ["esES"] = "Misiones de bots archivadas",
        ["frFR"] = "Quêtes des bots archivées",
    },
    ["Archived bots: "] = {
        ["ptBR"] = "Bots arquivados: ",
        ["ruRU"] = "Архивные боты: ",
        ["deDE"] = "Archivierte Bots: ",
        ["koKR"] = "보관된 봇: ",
        ["esMX"] = "Bots archivados: ",
        ["enUS"] = true,
        ["zhCN"] = "已归档机器人：",
        ["zhTW"] = "已封存機器人：",
        ["esES"] = "Bots archivados: ",
        ["frFR"] = "Bots archivés : ",
    },
    ["No archived bot quest cache yet."] = {
        ["ptBR"] = "Ainda não há cache de missões de bots arquivadas.",
        ["ruRU"] = "Архивного кэша заданий ботов пока нет.",
        ["deDE"] = "Es gibt noch keinen archivierten Bot-Quest-Cache.",
        ["koKR"] = "아직 보관된 봇 퀘스트 캐시가 없습니다.",
        ["esMX"] = "Todavía no hay caché de misiones de bots archivadas.",
        ["enUS"] = true,
        ["zhCN"] = "当前还没有已归档的机器人任务缓存。",
        ["zhTW"] = "目前沒有已封存的機器人任務快取。",
        ["esES"] = "Todavía no hay caché de misiones de bots archivadas.",
        ["frFR"] = "Il n'y a pas encore de cache de quêtes pour les bots archivés.",
    },
    ["No archived bot quests yet."] = {
        ["ptBR"] = "Ainda não há missões de bots arquivadas.",
        ["ruRU"] = "Архивных заданий ботов пока нет.",
        ["deDE"] = "Es gibt noch keine archivierten Bot-Quests.",
        ["koKR"] = "아직 보관된 봇 퀘스트가 없습니다.",
        ["esMX"] = "Todavía no hay misiones de bots archivadas.",
        ["enUS"] = true,
        ["zhCN"] = "当前还没有已归档的机器人任务。",
        ["zhTW"] = "目前沒有已封存的機器人任務。",
        ["esES"] = "Todavía no hay misiones de bots archivadas.",
        ["frFR"] = "Il n'y a pas encore de quêtes de bots archivées.",
    },
    ["No cached bot quests yet. Scan a quest giver once with your bots in group."] = {
        ["ptBR"] = "Ainda não há missões de bots em cache. Faça um scan de um doador de missões uma vez com seus bots no grupo.",
        ["ruRU"] = "Кэшированных заданий ботов пока нет. Один раз просканируйте NPC-выдающего задания, когда ваши боты в группе.",
        ["deDE"] = "Noch keine Bot-Quests im Cache. Scanne einmal einen Questgeber, während deine Bots in der Gruppe sind.",
        ["koKR"] = "아직 캐시된 봇 퀘스트가 없습니다. 봇들이 그룹에 있는 상태에서 퀘스트 NPC를 한 번 스캔하세요.",
        ["esMX"] = "Todavía no hay misiones de bots en caché. Escanea una vez a un dador de misiones con tus bots en el grupo.",
        ["enUS"] = true,
        ["zhCN"] = "当前还没有缓存的机器人任务。请在机器人在队伍中时扫描一次任务给予者。",
        ["zhTW"] = "目前沒有快取的機器人任務。請在機器人在隊伍中時掃描一次任務給予者。",
        ["esES"] = "Todavía no hay misiones de bots en caché. Escanea una vez a un dador de misiones con tus bots en el grupo.",
        ["frFR"] = "Aucune quête de bot en cache pour le moment. Scannez une fois un donneur de quête avec vos bots dans le groupe.",
    },
    ["In Progress"] = {
        ["ptBR"] = "Em andamento",
        ["ruRU"] = "В процессе",
    ...
    ["Ready to turn in: %s"] = {
        ["ptBR"] = "Pronta para entregar: %s",
        ["ruRU"] = "Готово к сдаче: %s",
        ["deDE"] = "Bereit zum Abgeben: %s",
        ["koKR"] = "반납 준비 완료: %s",
        ["esMX"] = "Lista para entregar: %s",
        ["enUS"] = true,
        ["zhCN"] = "准备交付：%s",
        ["zhTW"] = "可交回：%s",
        ["esES"] = "Lista para entregar: %s",
        ["frFR"] = "À rendre : %s",
    },
    ---------------------------------------------------------
    -- Sizer
